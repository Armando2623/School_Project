(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const o of document.querySelectorAll('link[rel="modulepreload"]'))a(o);new MutationObserver(o=>{for(const i of o)if(i.type==="childList")for(const s of i.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&a(s)}).observe(document,{childList:!0,subtree:!0});function r(o){const i={};return o.integrity&&(i.integrity=o.integrity),o.referrerPolicy&&(i.referrerPolicy=o.referrerPolicy),o.crossOrigin==="use-credentials"?i.credentials="include":o.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function a(o){if(o.ep)return;o.ep=!0;const i=r(o);fetch(o.href,i)}})();const Oe="sg_session",m={save(e){sessionStorage.setItem(Oe,JSON.stringify(e))},get(){try{return JSON.parse(sessionStorage.getItem(Oe))}catch{return null}},clear(){sessionStorage.removeItem(Oe)},token(){var e;return((e=this.get())==null?void 0:e.token)??null},usuario(){var e;return((e=this.get())==null?void 0:e.usuario)??null},nombre(){var e;return((e=this.get())==null?void 0:e.nombre)??null},rol(){var e;return((e=this.get())==null?void 0:e.rol)??null},id(){var e;return((e=this.get())==null?void 0:e.id)??null},isLogged(){return!!this.token()},hasRole(...e){return e.includes(this.rol())}},yt=[{section:"PRINCIPAL",items:[{icon:"fas fa-chart-line",label:"Dashboard",hash:"#/dashboard",roles:["ADMINISTRADOR","PORTERO","SECRETARIA","DIRECTOR","PROFESOR"]},{icon:"fas fa-clipboard-list",label:"Visitas",hash:"#/visitas",roles:["ADMINISTRADOR","PORTERO","SECRETARIA","DIRECTOR","PROFESOR"]}]},{section:"GESTIÓN",items:[{icon:"fas fa-users",label:"Visitantes",hash:"#/visitantes",roles:["ADMINISTRADOR","SECRETARIA"]},{icon:"fas fa-user-graduate",label:"Alumnos",hash:"#/alumnos",roles:["ADMINISTRADOR","SECRETARIA","PROFESOR"]},{icon:"fas fa-check-square",label:"Asistencia",hash:"#/asistencia",roles:["ADMINISTRADOR","DIRECTOR","SECRETARIA","PORTERO","PROFESOR"]},{icon:"fas fa-calendar-alt",label:"Agenda",hash:"#/agenda",roles:["ADMINISTRADOR","DIRECTOR","SECRETARIA","PORTERO","PROFESOR"]},{icon:"fas fa-boxes",label:"Inventario",hash:"#/inventario",roles:["ADMINISTRADOR","DIRECTOR","SECRETARIA","PORTERO","PROFESOR","ENCARGADO_INVENTARIO"]},{icon:"fas fa-user-cog",label:"Usuarios",hash:"#/usuarios",roles:["ADMINISTRADOR"]},{icon:"fas fa-history",label:"Auditoría",hash:"#/auditoria",roles:["ADMINISTRADOR"]}]}],Et={ADMINISTRADOR:"Administrador",PORTERO:"Portero",SECRETARIA:"Secretaria",DIRECTOR:"Director",PROFESOR:"Profesor",ENCARGADO_INVENTARIO:"Encargado de Inventario"};function St(e){const t=m.rol(),r=window.location.hash||"#/dashboard",a=yt.map(o=>{const i=o.items.filter(s=>!s.roles||s.roles.includes(t));return i.length?`
...
<div class="svc-row">
    ...
    </div>`;const t=m.token(),r=t?{Authorization:`Bearer ${t}`}:{},a=async(o,i,s={})=>{const n=e.querySelector(`#${i}`);try{const l=await fetch(o,{signal:AbortSignal.timeout(3e3),headers:s});n.classList.add(l.status<500?"online":"offline")}catch{n.classList.add("offline")}};a(`${Re}/api/alumnos`,"dot-mvc",r),a(`${Me}/api/asistencia`,"dot-ast",r);try{const[o,i]=await Promise.all([ae.listar(),ge.listar()]),s=o.filter(c=>{var u;return(u=c.horaIngreso)==null?void 0:u.startsWith(Ve())}),n=o.filter(c=>c.estadoRegistro==="EN_CURSO");e.querySelector("#s-activos").textContent=n.length,e.querySelector("#s-hoy").textContent=s.length,e.querySelector("#s-alumnos").textContent=i.length,e.querySelector("#footer-count").textContent=`${s.length} hoy`;const l=e.querySelector("#recent-tbody"),d=[...o].reverse().slice(0,5);d.length?l.innerHTML=d.map(c=>`
        <tr>
    ...
    </div>`,l.classList.add("active"),document.body.appendChild(l);const d=()=>{n&&n(),l.remove()};return l.querySelector("#modal-close-btn").addEventListener("click",d),(c=l.querySelector("#modal-cancel-btn"))==null||c.addEventListener("click",d),l.querySelector("#modal-confirm-btn").addEventListener("click",()=>{r?r(l,d):d()}),l.addEventListener("click",u=>{u.target===l&&d()}),s&&setTimeout(()=>s(l),0),l}const Tt=["REGISTRADO","EN_CURSO","COMPLETADO"],Ot={REGISTRADO:"badge-blue",EN_CURSO:"badge-yellow",COMPLETADO:"badge-green"},Dt=e=>`<span class="badge ${Ot[e]??"badge-gray"}">${e??"—"}</span>`,Ct=e=>e?new Date(e).toLocaleString("es-PE"):"—",Ee=()=>m.hasRole("ADMINISTRADOR","PORTERO","SECRETARIA");let ve=[];async function qt(e){var t,r;e.innerHTML=`
    <div class="page-topbar">
      <div>
    ...
    <tr>
      ...
      <td class="td-small">${Ct(a.horaIngreso)}</td>
    ...
    <div class="page-body">
      <div class="action-bar">
        ${Ae()?'<button class="btn btn-primary" id="btn-new">+ Nuevo Alumno</button>':""}
      </div>
      <div class="table-card">
        <div class="table-card-header">
    ...
    </tr>`}).join(""),Ae()&&r.querySelectorAll(".edit-btn").forEach(a=>a.addEventListener("click",()=>Ze(e,oe.find(o=>o.id==a.dataset.id)))),r.querySelectorAll(".qr-btn").forEach(a=>a.addEventListener("click",()=>Pt(a.dataset.id,a.dataset.nombre)))}async function Pt(e,t){let r=null;R({title:`📱 Código QR — ${t}`,bodyHTML:`
    ...
    </div>`,e.querySelectorAll(".tab-btn").forEach(l=>{l.addEventListener("click",()=>{ee=l.dataset.tab,e.querySelectorAll(".tab-btn").forEach(d=>{d.classList.toggle("active",d.dataset.tab===ee),d.classList.toggle("btn-primary",d.dataset.tab===ee),d.classList.toggle("btn-outline",d.dataset.tab!==ee)}),e.querySelector("#section-personal").style.display=ee==="personal"?"":"none",e.querySelector("#section-alumnos").style.display=ee==="alumnos"?"":"none"})});try{ot=await ne.listar()}catch{}await Ce(e,ie()),(r=e.querySelector("#btn-filter"))==null||r.addEventListener("click",()=>{const l=e.querySelector("#filter-fecha").value;l&&Ce(e,l)}),(a=e.querySelector("#btn-all"))==null||a.addEventListener("click",()=>_t(e)),(o=e.querySelector("#btn-new"))==null||o.addEventListener("click",()=>Gt(e)),await qe(e,ie()),(i=e.querySelector("#btn-filter-alumnos"))==null||i.addEventListener("click",()=>{const l=e.querySelector("#filter-fecha-alumnos").value;l&&qe(e,l)}),(s=e.querySelector("#btn-all-alumnos"))==null||s.addEventListener("click",()=>Qt(e)),(n=e.querySelector("#btn-scan-qr"))==null||n.addEventListener("click",()=>Jt(e))}async function Ce(e,t){try{z=await Ie.porFecha(t),e.querySelector("#total-personal").textContent=`${z.length}`,e.querySelector("#footer-personal").textContent=`${z.length} registros`,it(e,z)}catch{p("No se pudo conectar al servicio de asistencia (puerto 8081)","error")}}async function _t(e){try{z=await Ie.listar(),e.querySelector("#total-personal").textContent=`${z.length}`,e.querySelector("#footer-personal").textContent=`${z.length} registros totales`,it(e,z)}catch(t){p(t.message,"error")}}function it(e,t){const r=e.querySelector("#tbody-personal");if(!t.length){r.innerHTML='<tr class="empty-row"><td colspan="5">Sin registros para este filtro</td></tr>';return}r.innerHTML=t.map(a=>`
    <tr>
      ...
      </div>`,confirmText:"Registrar",onConfirm:async(a,o)=>{const i=a.querySelector("#m-usuario"),s=i.options[i.selectedIndex],n=i.value;if(!n){p("Selecciona un miembro del personal","warning");return}const l={usuarioId:Number(n),nombrePersonal:s.dataset.nombre,rolPersonal:s.dataset.rol,tipoEvento:a.querySelector("#m-tipo").value,horaEvento:a.querySelector("#m-hora").value?new Date(a.querySelector("#m-hora").value).toISOString():null,observaciones:a.querySelector("#m-obs").value.trim()||null};try{await Ie.registrar(l),p("Asistencia registrada","success"),o();const d=e.querySelector("#filter-fecha").value||ie();await Ce(e,d)}catch(d){p(d.message,"error")}}})}async function qe(e,t){try{U=await ke.porFecha(t),e.querySelector("#total-alumnos").textContent=`${U.length}`,e.querySelector("#footer-alumnos").textContent=`${U.length} registros`,rt(e,U)}catch{p("No se pudo cargar asistencia de alumnos","error")}}async function Qt(e){try{U=await ke.listar(),e.querySelector("#total-alumnos").textContent=`${U.length}`,e.querySelector("#footer-alumnos").textContent=`${U.length} registros totales`,rt(e,U)}catch(t){p(t.message,"error")}}function rt(e,t){const r=e.querySelector("#tbody-alumnos");if(!t.length){r.innerHTML='<tr class="empty-row"><td colspan="6">Sin registros para este filtro</td></tr>';return}r.innerHTML=t.map(a=>`
    <tr>
      ...
      </div>`,confirmText:"Cerrar",hideCancelBtn:!0,onOpen:async s=>{try{const{Html5Qrcode:n}=await Fe(async()=>{const{Html5Qrcode:d}=await import("./index-BNMS5zO2.js");return{Html5Qrcode:d}},[]);r=new n(t);const l={fps:10,qrbox:{width:220,height:220}};await r.start({facingMode:"environment"},l,d=>i(s,d),()=>{}),a=!0,s.querySelector("#scan-status").textContent="Esperando QR…"}catch(n){s.querySelector("#scan-status").textContent="No se pudo acceder a la cámara. "+(n.message||""),p("Error al iniciar la cámara","error")}},onClose:async()=>{if(r&&a)try{await r.stop()}catch{}}});let o=null;async function i(s,n){if(n!==o){if(o=n,r&&a)try{await r.pause()}catch{}s.querySelector("#scan-status").textContent="QR detectado — verificando alumno…";try{const{api:l}=await Fe(async()=>{const{api:c}=await Promise.resolve().then(()=>At);return{api:c}},void 0),d=await l.get(`/alumnos/qr/${n}`);s.querySelector("#scan-result").style.display="block",s.querySelector("#scan-nombre").textContent="🎒 "+d.nombre,s.querySelector("#scan-badges").innerHTML=`
        <span class="badge badge-blue">${d.grado}</span>
        <span class="badge badge-gray">${d.seccion}</span>`,s.querySelector("#scan-actions").style.display="block",s.querySelector("#scan-status").textContent="Selecciona el tipo de evento:",s.querySelector("#btn-entrada-qr").onclick=()=>ze(s,n,"ENTRADA",e),s.querySelector("#btn-salida-qr").onclick=()=>ze(s,n,"SALIDA",e)}catch{if(s.querySelector("#scan-status").textContent="❌ QR inválido — alumno no encontrado",p("QR no corresponde a ningún alumno","error"),o=null,r&&a)try{await r.resume()}catch{}}}}}async function ze(e,t,r,a){var s,n,l;const o=((n=(s=e.querySelector("#scan-obs"))==null?void 0:s.value)==null?void 0:n.trim())||null,i={codigoQr:t,tipoEvento:r,horaEvento:null,registradoPorId:m.id()?Number(m.id()):null,observaciones:o};try{await ke.registrar(i),p(`${r} del alumno registrada correctamente`,"success"),e.remove();const d=((l=a.querySelector("#filter-fecha-alumnos"))==null?void 0:l.value)||ie();await qe(a,d)}catch(d){p(d.message||"Error al registrar asistencia","error")}}const M={listarTodos:()=>A.get("/agenda"),listarPorProfesor:e=>A.get(`/agenda/profesor/${e}`),listarPorFecha:e=>A.get(`/agenda/fecha?fecha=${e}`),listarPorProfesorFecha:(e,t)=>A.get(`/agenda/profesor/${e}/fecha?fecha=${t}`),listarPorEstado:(e,t)=>A.get(`/agenda/profesor/${e}/estado/${t}`),listarRecurrentes:e=>A.get(`/agenda/recurrentes/${e}`),crear:e=>A.post("/agenda",e),actualizar:(e,t)=>A.put(`/agenda/${e}`,t),eliminar:e=>A.delete(`/agenda/${e}`),listarHorarios:()=>A.get("/horarios"),listarHorariosPorProfesor:e=>A.get(`/horarios/profesor/${e}`),listarHorariosPorDia:e=>A.get(`/horarios/dia/${e}`),crearHorario:e=>A.post("/horarios",e),actualizarHorario:(e,t)=>A.put(`/horarios/${e}`,t),eliminarHorario:e=>A.delete(`/horarios/${e}`)},nt=["Enero","Febrero","Marzo","Abril","Mayo","Junio","Julio","Agosto","Septiembre","Octubre","Noviembre","Diciembre"],Xt=["Dom","Lun","Mar","Mié","Jue","Vie","Sáb"],lt=["DOMINGO","LUNES","MARTES","MIERCOLES","JUEVES","VIERNES","SABADO"],K={HORARIO_ATENCION:{bg:"#6366f1",light:"#eef2ff",text:"#4338ca",label:"Atención"},REUNION:{bg:"#f59e0b",light:"#fffbeb",text:"#b45309",label:"Reunión"},ACTIVIDAD:{bg:"#10b981",light:"#ecfdf5",text:"#047857",label:"Actividad"},OTRO:{bg:"#64748b",light:"#f1f5f9",text:"#334155",label:"Otro"}},he={ACTIVO:{bg:"#dcfce7",text:"#16a34a",label:"Activo"},CANCELADO:{bg:"#fee2e2",text:"#dc2626",label:"Cancelado"},COMPLETADO:{bg:"#e0e7ff",text:"#4338ca",label:"Completado"}},we=e=>e?new Date(e).toLocaleTimeString("es-PE",{hour:"2-digit",minute:"2-digit"}):"—",Yt=e=>e?new Date(e).toLocaleDateString("es-PE",{day:"2-digit",month:"short",year:"numeric"}):"—",xe=e=>e.toISOString().split("T")[0];let F=new Date().getFullYear(),q=new Date().getMonth(),j=[],Z=[],w=null,De="calendario";async function Wt(e){const t=m.hasRole("ADMINISTRADOR","DIRECTOR","PROFESOR"),r=m.hasRole("ADMINISTRADOR","DIRECTOR");e.innerHTML=Kt(t,r),Zt(e);const a=m.hasRole("PROFESOR")?m.id():null;await le(a),_(e),W(e),ea(e)}function Kt(e,t){const r=m.hasRole("PROFESOR");return`
  <div class="page-topbar">
    <div>
  ...
  <div id="tab-horarios" class="tab-content" style="display:none">
    <div class="table-card">
  ...
  </div>`}async function le(e=null){try{const[t,r]=await Promise.all([e?M.listarPorProfesor(e):M.listarTodos(),e?M.listarHorariosPorProfesor(e):M.listarHorarios()]);j=t||[],Z=r||[]}catch(t){p(`Error cargando datos: ${t.message}`,"error"),j=[],Z=[]}}function _(e){const t=e.querySelector("#cal-month-label"),r=e.querySelector("#cal-grid");if(!t||!r)return;t.textContent=`${nt[q]} ${F}`;const a=new Date(F,q,1).getDay(),o=new Date(F,q+1,0).getDate(),i=new Date;let s=Xt.map(n=>`<div class="cal-day-header">${n}</div>`).join("");for(let n=0;n<a;n++)s+='<div class="cal-cell cal-empty"></div>';for(let n=1;n<=o;n++){const l=new Date(F,q,n),d=xe(l),c=n===i.getDate()&&q===i.getMonth()&&F===i.getFullYear(),u=w===d,b=j.filter(v=>{const E=new Date(v.fechaInicio);return E.getFullYear()===F&&E.getMonth()===q&&E.getDate()===n}),h=[...new Set(b.map(v=>v.tipoAgenda))].slice(0,3).map(v=>{var E;return`<span class="cal-dot" style="background:${((E=K[v])==null?void 0:E.bg)??"#888"}"></span>`}).join("");s+=`
      ...
      </div>`}r.innerHTML=s,r.querySelectorAll(".cal-cell[data-date]").forEach(n=>{n.addEventListener("click",()=>{w=n.dataset.date,_(e),Y(e,w)})})}function Y(e,t){const r=e.querySelector("#day-events-title"),a=e.querySelector("#day-events-list");if(!r||!a)return;const o=new Date(t+"T00:00:00");r.innerHTML=`<i class="fas fa-calendar-day"></i>
    Eventos del ${o.getDate()} de ${nt[o.getMonth()]} ${o.getFullYear()}`;const i=j.filter(s=>{const n=new Date(s.fechaInicio);return xe(n)===t});if(!i.length){a.innerHTML='<div class="day-empty"><i class="fas fa-calendar-xmark"></i><span>Sin eventos este día</span></div>';return}a.innerHTML=i.map(s=>{const n=K[s.tipoAgenda]??K.OTRO,l=he[s.estado]??he.ACTIVO;return`
      <div class="day-event-item" style="border-left:4px solid ${n.bg}">
        ...
        <div class="day-event-meta">
          ...
          <span><i class="fas fa-clock"></i> ${we(s.fechaInicio)} – ${we(s.fechaFin)}</span>
      ...
      <tr>
        ...
        <td style="font-variant-numeric:tabular-nums;font-size:13px">
          ${we(s.fechaInicio)} – ${we(s.fechaFin)}
        </td>
    ...
    <div class="form-grid-2">
      ...
      <div class="form-group">
        ...
        <input id="ev-fecha" type="date" class="form-input" value="${t?xe(new Date(t.fechaInicio)):w??xe(new Date)}"/>
      </div>
      <div class="form-group">
    ...
    </div>`;R({title:a,bodyHTML:l,onConfirm:async(d,c)=>{const u={profesorId:Number(document.getElementById("ev-profesorId").value),nombreProfesor:document.getElementById("ev-nombreProfesor").value.trim(),especialidad:document.getElementById("ev-especialidad").value.trim()||null,titulo:document.getElementById("ev-titulo").value.trim(),descripcion:document.getElementById("ev-descripcion").value.trim()||null,fechaInicio:document.getElementById("ev-inicio").value,fechaFin:document.getElementById("ev-fin").value,tipoAgenda:document.getElementById("ev-tipo").value,estado:document.getElementById("ev-estado").value,lugar:document.getElementById("ev-lugar").value.trim()||null,recurrente:document.getElementById("ev-recurrente").checked,diaSemana:document.getElementById("ev-recurrente").checked?document.getElementById("ev-diaSemana").value:null};if(!u.profesorId||!u.nombreProfesor||!u.titulo||!u.fechaInicio||!u.fechaFin){p("Completa los campos obligatorios (*)","error");return}try{r?(await M.actualizar(t.id,u),p("Evento actualizado correctamente","success")):(await M.crear(u),p("Evento creado correctamente","success"));const b=m.hasRole("PROFESOR")?m.id():null;await le(b),_(e),re(e),w&&Y(e,w),c()}catch(b){p(`Error: ${b.message}`,"error")}}}),setTimeout(()=>{var v,E,Q,P;const d=y=>{if(!y)return"";const[$,S,x]=y.split("-").map(Number),T=new Date($,S-1,x).getDay();return["DOMINGO","LUNES","MARTES","MIERCOLES","JUEVES","VIERNES","SABADO"][T]},c=y=>{const S={DOMINGO:0,LUNES:1,MARTES:2,MIERCOLES:3,JUEVES:4,VIERNES:5,SABADO:6}[y];if(S===void 0)return null;const x=new Date,k=x.getDay();let T=S-k;T<0&&(T+=7);const I=new Date(x.getFullYear(),x.getMonth(),x.getDate()+T),D=I.getFullYear(),V=String(I.getMonth()+1).padStart(2,"0"),N=String(I.getDate()).padStart(2,"0");return`${D}-${V}-${N}`},u=(y=!1)=>{const $=document.getElementById("ev-horario-select");if(!$)return;const S=$.options[$.selectedIndex],x=document.getElementById("ev-fecha"),k=document.getElementById("ev-inicio"),T=document.getElementById("ev-fin");if(S&&S.dataset.dia){const D=S.dataset.dia;if(!y&&x){const V=c(D);V&&(x.value=V)}}const I=x==null?void 0:x.value;if(I&&S&&S.dataset.inicio&&S.dataset.fin){const D=S.dataset.inicio,V=S.dataset.fin;k&&(k.value=`${I}T${D}`),T&&(T.value=`${I}T${V}`);const N=S.dataset.dia,J=document.getElementById("ev-diaSemana");N&&J&&(J.value=N);const f=S.dataset.materia,H=document.getElementById("ev-especialidad");f&&H&&(H.value=f);const L=document.getElementById("ev-fecha-warning");if(N){const C=d(I);if(C!==N){const ce={LUNES:"Lunes",MARTES:"Martes",MIERCOLES:"Miércoles",JUEVES:"Jueves",VIERNES:"Viernes",SABADO:"Sábado",DOMINGO:"Domingo"},Le=ce[N]||N,Te=ce[C]||C;L&&(L.innerHTML=`<i class="fas fa-exclamation-triangle"></i> La fecha seleccionada es <strong>${Te}</strong>, pero el horario seleccionado es para los <strong>${Le}</strong>.`,L.style.display="block")}else L&&(L.style.display="none",L.innerHTML="")}else L&&(L.style.display="none",L.innerHTML="")}else{k&&(k.value=""),T&&(T.value="");const D=document.getElementById("ev-fecha-warning");D&&(D.style.display="none",D.innerHTML="")}},b=async y=>{var S,x,k;const $=document.getElementById("ev-horario-select");if($){$.innerHTML='<option value="">Cargando horarios...</option>';try{const I=(await M.listarHorariosPorProfesor(y)||[]).filter(f=>f.activo),D=((S=j.find(f=>f.profesorId==y&&f.especialidad))==null?void 0:S.especialidad)||((x=I.find(f=>f.materia))==null?void 0:x.materia)||((k=Z.find(f=>f.profesorId==y&&f.materia))==null?void 0:k.materia)||"",V=document.getElementById("ev-especialidad");if(V&&D&&(V.value=D),I.length===0){$.innerHTML='<option value="">El profesor no tiene horarios registrados</option>',u(!0);return}const N={LUNES:"Lunes",MARTES:"Martes",MIERCOLES:"Miércoles",JUEVES:"Jueves",VIERNES:"Viernes",SABADO:"Sábado",DOMINGO:"Domingo"};let J='<option value="">Seleccione un horario...</option>';if(I.forEach(f=>{const H=f.horaInicio.slice(0,5),L=f.horaFin.slice(0,5),C=N[f.diaSemana]||f.diaSemana;let ce=!1;if(t){const Le=n(t.fechaInicio).split("T")[1],Te=n(t.fechaFin).split("T")[1];Le===H&&Te===L&&f.diaSemana===t.diaSemana&&(ce=!0)}J+=`<option value="${f.id}" data-inicio="${H}" data-fin="${L}" data-dia="${f.diaSemana}" data-materia="${f.materia}" ${ce?"selected":""}>
            ${C}: ${H} - ${L} (${f.materia}${f.aula?" · "+f.aula:""})
          </option>`}),t){const f=n(t.fechaInicio).split("T")[1],H=n(t.fechaFin).split("T")[1];if(!I.some(C=>C.horaInicio.slice(0,5)===f&&C.horaFin.slice(0,5)===H&&C.diaSemana===t.diaSemana)){const C=N[t.diaSemana]||t.diaSemana||"";J=`<option value="original" data-inicio="${f}" data-fin="${H}" data-dia="${t.diaSemana}" selected>
              [Horario Original] ${C?C+": ":""}${f} - ${H}
  ...
  </p>`,onConfirm:async(i,s)=>{try{r==="evento"?(await M.eliminar(t),p("Evento eliminado","success")):(await M.eliminarHorario(t),p("Horario eliminado","success"));const n=m.hasRole("PROFESOR")?m.id():null;await le(n),_(e),re(e),W(e),w&&Y(e,w),s()}catch(n){p(`Error: ${n.message}`,"error")}}})}const ta={listar:()=>g.get("/auditoria")};let be=[];const aa={ADMINISTRADOR:"badge-red",PORTERO:"badge-blue",SECRETARIA:"badge-green",DIRECTOR:"badge-yellow",PROFESOR:"badge-purple",SISTEMA:"badge-gray"},sa=e=>`<span class="badge ${aa[e]??"badge-gray"}">${e}</span>`;function oa(e){return e?new Date(e).toLocaleString("es-PE",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit",second:"2-digit"}):""}async function ia(e){e.innerHTML=`
    <div class="page-topbar">
      <div>
